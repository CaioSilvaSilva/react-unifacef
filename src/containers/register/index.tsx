        ...
        <Form>
          <Form.Group widths='equal'>
            <Form.Field>
              ...
              <input value={zipcode || ''} maxLength={8} name='zipcode' onChange={handleForm} placeholder='Ex 14400000' />
            </Form.Field>
            <Form.Field>
              <Cep zipCode={zipcode} />
            </Form.Field>
          ...
          <Form.Group widths='equal'>
            <Form.Field>
              ...
              <input value={github || ''} maxLength={20} name='github' onChange={handleForm} placeholder='Ex: CaioSilvaSilva' />
            </Form.Field>
            <Form.Field>
