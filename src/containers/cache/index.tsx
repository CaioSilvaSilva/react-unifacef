        ...
        <Form onSubmit={submitForm}>
          <Form.Group widths='equal'>
            <Form.Field>
              ...
              <input value={local || ''} name='local' onChange={handleForm} placeholder='Local Storage' />
            </Form.Field>
            <Form.Field>
              <label>Session Storage</label>
              <input value={session || ''} name='session' onChange={handleForm} placeholder='Session Storage' />
            </Form.Field>
            <Form.Field>
              <label>Cookie</label>
              <input value={cookie || ''} name='cookie' onChange={handleForm} placeholder='Cookie' />
            </Form.Field>
          </Form.Group>
